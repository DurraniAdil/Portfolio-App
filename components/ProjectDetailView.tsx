    ...
    return (
        <div className={`fixed inset-0 z-[60] bg-os-bg flex flex-col transition-transform duration-300 ease-out ${visible ? 'translate-y-0' : 'translate-y-full'}`}>
            ...
            <div className="h-14 flex items-center justify-between px-4 border-b border-os-border bg-os-bg/95 backdrop-blur z-20">
                <button onClick={handleClose} className="p-2 -ml-2 text-white hover:bg-white/10 rounded-full">
                    <ArrowLeft size={24} />
                </button>
                <span className="font-bold text-sm text-white uppercase tracking-widest font-mono">CASE STUDY</span>
                <button onClick={handleClose} className="p-2 -mr-2 text-neutral-400 hover:text-white">
                    <X size={24} />
                </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto pb-24 no-scrollbar">
                ...
                <div className="relative w-full aspect-video">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-os-bg to-transparent"></div>
                    <div className="absolute bottom-4 left-4 right-4">
                        <h1 className="text-3xl font-bold text-white mb-1 leading-tight">{project.title}</h1>
                ...
                <div className="px-5 mt-6">
                    ...
                    <div className="flex gap-4 mb-8 border-b border-os-border pb-6">
                        <div>
                            <div className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider">Role</div>
                            <div className="text-sm font-medium text-white">{project.role}</div>
                        </div>
                        <div>
                            <div className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider">Year</div>
                            <div className="text-sm font-medium text-white">{project.year}</div>
                        </div>
                        <div>
                            <div className="text-[10px] text-neutral-500 uppercase font-bold tracking-wider">Time</div>
                            <div className="text-sm font-medium text-white">{project.stats.duration}</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <p className="text-neutral-300 leading-relaxed text-sm">{project.details.problem}</p>
                        </section>

                        <section>
                            <SectionTitle>Technical Approach</SectionTitle>
                            <p className="text-neutral-300 leading-relaxed text-sm mb-4">{project.details.approach}</p>
                        ...
                        <section>
                            ...
                            <p className="text-neutral-300 leading-relaxed text-sm">{project.details.outcome}</p>
                        </section>
                    </div>
